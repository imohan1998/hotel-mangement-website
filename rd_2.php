...
<body>
	<div id="full">
		<div  style="background-image: url('img/bms.jpg');background-size: 100% 710px; width: 100%; height: 1000px;background-repeat: repeat">
		<div id="header">
			<div id="logo">
		...
		<div id="banner"><br><br><br><br><br><br><br><br><br><br><br>
			<a href="ahome.php"><h1 style="color:blue;text-align: center; ">Welcome Admin</h1></a>
			...
			<table>
				...
				<tr>
					...
					<td><a style="color: red" href="roomdel.php? rno=<?php echo $rno; ?>" >DELETE</a> </td>
				</tr>
				<?php
			}
				?>
